  ...
  return (
    ...
    <div class="container px-5 py-24 mx-auto">
      <div class="flex flex-col text-center w-full mb-20">
        <h2 class="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">USERNAME {username.user.username}</h2>
      ...
      {testResults.map((result,index)=>(
         ...
         <div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
           <h2 class="text-lg sm:text-xl text-gray-900 font-medium title-font mb-2">{result.test}</h2>
           <p class="leading-relaxed text-base mb-4">{result.score}</p>
